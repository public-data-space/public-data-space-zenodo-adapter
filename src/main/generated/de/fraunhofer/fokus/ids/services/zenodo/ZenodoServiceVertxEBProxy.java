...
public class ZenodoServiceVertxEBProxy implements ZenodoService {
  private Vertx _vertx;
  private String _address;
  private DeliveryOptions _options;
  private boolean closed;

  public ZenodoServiceVertxEBProxy(Vertx vertx, String address) {
    this(vertx, address, null);
  }

  public ZenodoServiceVertxEBProxy(Vertx vertx, String address, DeliveryOptions options) {
    this._vertx = vertx;
  ...
  public  ZenodoService query(JsonObject dataSource, String recordId, String accessToken, Handler<AsyncResult<JsonObject>> resultHandler){
    ...
    _json.put("dataSource", dataSource);
    _json.put("recordId", recordId);
    _json.put("accessToken", accessToken);
